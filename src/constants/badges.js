...
export const BADGES = [
  ...
  { id: 'c1',  name: 'Icebreaker',         desc: 'Complete your first Versus match',                cat: 'challenge', tier: 1, Icon: Swords,      innerBg: 'linear-gradient(135deg,#0c4a6e,#0369a1)', innerIcon: '#7dd3fc', check: (p)   => (p.versusMatchesPlayed || 0) >= 1   },
  ...
  { id: 'c3',  name: 'King of the Sheet', desc: 'Win 3 Versus matches against opponents',          cat: 'challenge', tier: 3, Icon: Trophy,      innerBg: 'linear-gradient(135deg,#1e3a8a,#2563eb)', innerIcon: '#bfdbfe', check: (p)   => (p.versusWins          || 0) >= 3   },
  { id: 'u1',  name: 'Top Shelf Sniper',  desc: 'Score a perfect 5/5 in a single Versus turn',    cat: 'challenge', tier: 3, Icon: Target,      innerBg: 'linear-gradient(135deg,#713f12,#f97316)', innerIcon: '#fed7aa', check: (p)   => (p.perfectVersusTurns  || 0) >= 1   },
